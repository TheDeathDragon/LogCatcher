...
public enum Format {
	...
	private static final HashMap<String,Format> VALUE_MAP = new HashMap<>();
	...
	private final Pattern mLevelPattern;
	
	Format(String value, int titleId, Pattern levelPattern) {
		mValue = value;
		mTitleId = titleId;
